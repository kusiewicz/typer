...
import { AddTeamForm } from "~/pages/add-team/ui/add-team-form";
...
import { EditTeamForm } from "~/pages/add-team/ui/edit-team-form";
import { useDeleteTeam } from "~/pages/add-team/hooks/use-team-form";

export const AddTeamPage = () => {
  const router = useRouter();
  const routeApi = getRouteApi("/_authed/add-team");

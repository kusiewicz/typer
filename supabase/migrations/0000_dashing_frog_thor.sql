...
ALTER TABLE "user_match_predictions" ADD CONSTRAINT "user_match_predictions_match_id_matches_id_fk" FOREIGN KEY ("match_id") REFERENCES "public"."matches"("id") ON DELETE no action ON UPDATE no action;